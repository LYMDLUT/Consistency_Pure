...
logger.add(f"../../cm_result_attack/{FLAGS.save_folder}/cm_linf_attack/{FLAGS.model_type}/log_test_edm_sigma_max_{sigma_max}_step_{Num_inference_steps}_bs_{batch_size}_num_test_{num_test}_pgd_{pgd_step}_eot_{eot_step}.log")
